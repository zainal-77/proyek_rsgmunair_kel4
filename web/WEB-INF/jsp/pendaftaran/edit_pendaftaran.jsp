...
if(action != null && action.equals("edit_pendaftaran")){
...
<div class="pure-g">
	...
	<div class="pure-u-11-12" align="left">
		<h2>Edit Data Pendaftaran Pasien</h2>
		<hr>
...
<div class="pure-g">
	<div class="pure-u-1-12"></div>
	<div class="pure-u-11-12" align="left">
		<form class="pure-form pure-form-aligned" method="post" action="?act=edit_pendaftaran">
