		...
		<input type="hidden" name="action" value="add_pendaftaran" />
			<fieldset>
				...
				<div class="pure-control-group">
					...
					<input type="text" name="deskripsiKeluhan" id="aligned-deskripsiKeluhan" placeholder="Deskripsi Keluhan" height="300px" value="<%=pendaftaran.getString("deskripsiKeluhan")%>" />
				</div>
